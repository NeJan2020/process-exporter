...
func TestTrackerBasic(t *testing.T) {
	...
	tr := NewTracker(newNamer(n1, n2, n4), false, false, false, 0, false)
...
func TestTrackerChildren(t *testing.T) {
	...
	tr := NewTracker(newNamer(n2), true, false, false, 0, false)
...
func TestTrackerMetrics(t *testing.T) {
	...
	tr := NewTracker(newNamer(n), false, false, false, 0, false)
